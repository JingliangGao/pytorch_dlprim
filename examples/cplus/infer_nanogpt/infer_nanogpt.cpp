...
void load_device() {
    const char* lib_path = "/home/kylin/gjl/project/pytorch_dlprim/build/debug/torch_kpu/libtorch_kpu.so";
...
int main(int argc, char **argv) {
    ...
    if (mode == "train") {
        ...
        DataLoader loader("/home/kylin/gjl/project/pytorch_dlprim/examples/data/shakespeare_char", batch_size, block_size);
