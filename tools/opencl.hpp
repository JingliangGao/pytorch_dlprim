...
#define CL_HPP_CREATE_CL_EXT_FCN_PTR_ALIAS_(name) using PFN_##name = name##_fn
...
#define CL_HPP_INIT_CL_EXT_FCN_PTR_PLATFORM_(platform, name)                                       \
    if (!pfn_##name)                                                                               \
    {                                                                                              \
        pfn_##name = (PFN_##name)CL_(clGetExtensionFunctionAddressForPlatform)(platform, #name);   \
    }
...
#define __CREATE_SEMAPHORE_KHR_WITH_PROPERTIES_ERR                                                 \
    CL_HPP_ERR_STR_(clCreateSemaphoreWithPropertiesKHR)
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueAcquireExternalMemObjectsKHR
    pfn_clEnqueueAcquireExternalMemObjectsKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueReleaseExternalMemObjectsKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCreateSemaphoreWithPropertiesKHR
    pfn_clCreateSemaphoreWithPropertiesKHR = nullptr;
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueWaitSemaphoresKHR pfn_clEnqueueWaitSemaphoresKHR =
    nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clEnqueueSignalSemaphoresKHR pfn_clEnqueueSignalSemaphoresKHR =
    nullptr;
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetSemaphoreHandleForTypeKHR pfn_clGetSemaphoreHandleForTypeKHR =
    nullptr;
#endif // cl_khr_external_semaphore
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clFinalizeCommandBufferKHR pfn_clFinalizeCommandBufferKHR =
    nullptr;
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandBarrierWithWaitListKHR
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyBufferRectKHR pfn_clCommandCopyBufferRectKHR =
    nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyBufferToImageKHR pfn_clCommandCopyBufferToImageKHR =
    nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyImageKHR pfn_clCommandCopyImageKHR = nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCommandCopyImageToBufferKHR pfn_clCommandCopyImageToBufferKHR =
    nullptr;
...
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clUpdateMutableCommandsKHR pfn_clUpdateMutableCommandsKHR =
    nullptr;
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetMutableCommandInfoKHR pfn_clGetMutableCommandInfoKHR =
    nullptr;
#endif /* cl_khr_command_buffer_mutable_dispatch */

#if defined(cl_ext_image_requirements_info)
CL_HPP_CREATE_CL_EXT_FCN_PTR_ALIAS_(clGetImageRequirementsInfoEXT);
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clGetImageRequirementsInfoEXT pfn_clGetImageRequirementsInfoEXT =
    nullptr;
#endif

#if defined(cl_ext_device_fission)
CL_HPP_CREATE_CL_EXT_FCN_PTR_ALIAS_(clCreateSubDevicesEXT);
CL_HPP_DEFINE_STATIC_MEMBER_ PFN_clCreateSubDevicesEXT pfn_clCreateSubDevicesEXT = nullptr;
#endif
...
inline cl_int getInfoHelper(Func f, cl_uint name, vector<vector<unsigned char>>* param, int)
{
    ...
    if (param)
    {
        ...
        cl_int err =
            f(name, numBinaries * sizeof(unsigned char*), binariesPointers.data(), nullptr);
...
#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_MEMORY_(F)                                               \
    F(cl_device_info,                                                                              \
      ...
      cl::vector<cl::ExternalMemoryType>)                                                          \
    F(cl_platform_info,                                                                            \
...
#define CL_HPP_PARAM_NAME_CL_KHR_EXTERNAL_SEMAPHORE_(F)                                            \
    F(cl_platform_info,                                                                            \
      ...
      cl::vector<cl_external_semaphore_handle_type_khr>)                                           \
    F(cl_platform_info,                                                                            \
...
#define CL_HPP_PARAM_NAME_CL_INTEL_COMMAND_QUEUE_FAMILIES_(F)                                      \
    F(cl_device_info,                                                                              \
      ...
      cl::vector<cl_queue_family_properties_intel>)                                                \
                                                                                                   \
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_semaphore_info_khr, CL_SEMAPHORE_DEVICE_HANDLE_LIST_KHR, cl::vector<cl::Device>)
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_device_info, CL_DEVICE_SUPPORTED_REGISTER_ALLOCATIONS_ARM, vector<cl_uint>)
#endif
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_kernel_exec_info, CL_KERNEL_EXEC_INFO_COMPUTE_UNIT_MAX_QUEUED_BATCHES_ARM, cl_uint)
#endif
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    ...
    cl_command_queue_properties)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_command_buffer_info_khr, CL_COMMAND_BUFFER_QUEUES_KHR, cl::vector<CommandQueue>)
CL_HPP_DECLARE_PARAM_TRAITS_(cl_command_buffer_info_khr, CL_COMMAND_BUFFER_NUM_QUEUES_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_command_buffer_info_khr, CL_COMMAND_BUFFER_REFERENCE_COUNT_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_command_buffer_info_khr, CL_COMMAND_BUFFER_STATE_KHR, cl_command_buffer_state_khr)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_command_buffer_info_khr,
    CL_COMMAND_BUFFER_PROPERTIES_ARRAY_KHR,
    cl::vector<cl_command_buffer_properties_khr>)
#endif /* cl_khr_command_buffer */

#if defined(cl_khr_command_buffer_mutable_dispatch)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_COMMAND_COMMAND_QUEUE_KHR, CommandQueue)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_COMMAND_COMMAND_BUFFER_KHR, CommandBufferKhr)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_COMMAND_COMMAND_TYPE_KHR, cl_command_type)
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    ...
    cl::vector<cl_command_properties_khr>)
#else
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr,
    CL_MUTABLE_DISPATCH_PROPERTIES_ARRAY_KHR,
    cl::vector<cl_ndrange_kernel_command_properties_khr>)
#endif
CL_HPP_DECLARE_PARAM_TRAITS_(cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_KERNEL_KHR, cl_kernel)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_DIMENSIONS_KHR, cl_uint)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_GLOBAL_WORK_OFFSET_KHR, cl::vector<size_type>)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_GLOBAL_WORK_SIZE_KHR, cl::vector<size_type>)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_mutable_command_info_khr, CL_MUTABLE_DISPATCH_LOCAL_WORK_SIZE_KHR, cl::vector<size_type>)
#endif /* cl_khr_command_buffer_mutable_dispatch */
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_device_info, CL_DEVICE_SPIRV_EXTENDED_INSTRUCTION_SETS_KHR, cl::vector<const char*>)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_device_info, CL_DEVICE_SPIRV_EXTENSIONS_KHR, cl::vector<const char*>)
...
CL_HPP_DECLARE_PARAM_TRAITS_(
    ...
    cl_device_fp_atomic_capabilities_ext)
CL_HPP_DECLARE_PARAM_TRAITS_(
    cl_device_info, CL_DEVICE_HALF_FP_ATOMIC_CAPABILITIES_EXT, cl_device_fp_atomic_capabilities_ext)
...
#ifdef cl_khr_semaphore
template <> struct ReferenceHandler<cl_semaphore_khr>
{
...
#endif // cl_khr_semaphore
#if defined(cl_khr_command_buffer)
template <> struct ReferenceHandler<cl_command_buffer_khr>
{
...
template <> struct ReferenceHandler<cl_mutable_command_khr>
{
  ...
  public:
    ...
    template <typename T> cl_int getInfo(cl_device_info name, T* param) const
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetDeviceInfo), object_, name, param), __GET_DEVICE_INFO_ERR);
    }
    ...
    {
        cl_ulong retVal = 0;
        cl_int err = CL_(clGetHostTimer)(this->get(), &retVal);
    ...
    std::pair<cl_ulong, cl_ulong> getDeviceAndHostTimer(cl_int* error = nullptr)
    {
        ...
        cl_int err = CL_(clGetDeviceAndHostTimer)(this->get(), &(retVal.first), &(retVal.second));
    ...
    cl_int
    createSubDevices(const cl_device_partition_property* properties, vector<Device>* devices);
#endif // defined (CL_HPP_TARGET_OPENCL_VERSION >= 120)

#if defined(cl_ext_device_fission)
    //! \brief Wrapper for clCreateSubDevices().
    cl_int
    createSubDevices(const cl_device_partition_property_ext* properties, vector<Device>* devices);
#endif // defined(cl_ext_device_fission)
};

using BuildLogType = vector<std::pair<
    cl::Device,
    typename detail::param_traits<detail::cl_program_build_info, CL_PROGRAM_BUILD_LOG>::
        param_type>>;
#if defined(CL_HPP_ENABLE_EXCEPTIONS)
/**
...
class Platform : public detail::Wrapper<cl_platform_id>
{
  ...
  public:
    ...
    static Platform getDefault(cl_int* errResult = nullptr)
    {
        std::call_once(default_initialized_, makeDefault);
        detail::errHandler(default_error_);
        if (errResult != nullptr)
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetPlatformInfo), object_, name, param), __GET_PLATFORM_INFO_ERR);
    }
        ...
        vector<Device>& devices) const
    {
        ...
        cl_int err = pfn_clGetDeviceIDsFromD3D10KHR(
            object_, d3d_device_source, d3d_object, d3d_device_set, 0, nullptr, &n);
        if (err != CL_SUCCESS)
        {
            return detail::errHandler(err, __GET_DEVICE_IDS_ERR);
        }
        ...
        err = pfn_clGetDeviceIDsFromD3D10KHR(
            object_, d3d_device_source, d3d_object, d3d_device_set, n, ids.data(), nullptr);
        if (err != CL_SUCCESS)
        {
            return detail::errHandler(err, __GET_DEVICE_IDS_ERR);
        }
   ...
   //! \brief Wrapper for clCreateSubDevices().
inline cl_int
Device::createSubDevices(const cl_device_partition_property* properties, vector<Device>* devices)
{
    cl_uint n = 0;
...
#if defined(cl_ext_device_fission)
//! \brief Wrapper for clCreateSubDevices().
inline cl_int Device::createSubDevices(
 ...
 */
inline CL_API_PREFIX__VERSION_1_1_DEPRECATED cl_int UnloadCompiler()
...
class Context : public detail::Wrapper<cl_context>
{
  private:
    ...
    static void makeDefault()
    {
...
#endif
        {
            ...
            default_ =
                Context(CL_DEVICE_TYPE_DEFAULT, properties, nullptr, nullptr, &default_error_);
        }
#if defined(CL_HPP_ENABLE_EXCEPTIONS)
        catch (cl::Error& e)
        {
    ...
    static cl_int getImageRequirementsInfoExtHelper(
  ...
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        object_ = CL_(clCreateContext)(properties, 1, &deviceID, notifyFptr, data, &error);
...
#endif
        object_ = CL_(clCreateContextFromType)(properties, type, notifyFptr, data, &error);
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetContextInfo), object_, name, param), __GET_CONTEXT_INFO_ERR);
    }
        ...
        cl_mem_flags flags, cl_mem_object_type type, vector<ImageFormat>& formats) const
    {
        ...
        cl_int err = CL_(clGetSupportedImageFormats)(object_, flags, type, 0, nullptr, &numEntries);
        if (err != CL_SUCCESS)
        {
        ...
        if (numEntries > 0)
        {
            ...
            err = CL_(clGetSupportedImageFormats)(
                object_, flags, type, numEntries, (cl_image_format*)value.data(), nullptr);
            if (err != CL_SUCCESS)
            {
                return detail::errHandler(err, __GET_SUPPORTED_IMAGE_FORMATS_ERR);
            }
...
#if defined(cl_ext_image_requirements_info)
    template <typename T>
    cl_int getImageRequirementsInfoExt(
        cl_image_requirements_info_ext name,
        T* param,
        cl_mem_flags flags = 0,
    ...
    template <cl_image_requirements_info_ext type>
    typename detail::param_traits<detail::cl_image_requirements_info_ext, type>::param_type
        ...
        cl_int* err = nullptr) const
    {
        typename detail::param_traits<detail::cl_image_requirements_info_ext, type>::param_type
            param{};
        cl_int result =
            getImageRequirementsInfoExt(type, &param, flags, properties, image_format, image_desc);
        if (err != nullptr)
        {
            *err = result;
        }
    ...
    cl_int setDestructorCallback(
        void(CL_CALLBACK* pfn_notify)(cl_context, void*), void* user_data = nullptr)
    {
        return detail::errHandler(
            CL_(clSetContextDestructorCallback)(object_, pfn_notify, user_data),
...
class Event : public detail::Wrapper<cl_event>
{
  public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetEventInfo), object_, name, param), __GET_EVENT_INFO_ERR);
    }
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetEventProfilingInfo), object_, name, param),
    ...
    cl_int wait() const
    {
        return detail::errHandler(CL_(clWaitForEvents)(1, &object_), __WAIT_FOR_EVENTS_ERR);
    }
    ...
    {
        return detail::errHandler(
            CL_(clSetEventCallback)(object_, type, pfn_notify, user_data),
    ...
    {
        static_assert(
            sizeof(cl::Event) == sizeof(cl_event),
...
class UserEvent : public Event
{
  public:
    ...
    {
        cl_int error;
        object_ = CL_(clCreateUserEvent)(context(), &error);
    ...
    {
        return detail::errHandler(
            CL_(clSetUserEventStatus)(object_, status), __SET_USER_EVENT_STATUS_ERR);
    }
};
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 110
...
class Memory : public detail::Wrapper<cl_mem>
{
  public:
    ...
    {
        return detail::errHandler(
            CL_(clSetMemObjectDestructorCallback)(object_, pfn_notify, user_data),
...
template <typename T, class SVMTrait> class SVMAllocator
{
  ...
  public:
        ...
        bool map = true)
    {
        ...
        void* voidPointer =
            CL_(clSVMAlloc)(context_(), SVMTrait::getSVMMemFlags(), size * sizeof(T), 0);
...
class Buffer : public Memory
{
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        if (properties.empty())
        {
            object_ = CL_(clCreateBufferWithProperties)(
                context(), nullptr, flags, size, host_ptr, &error);
        }
        else
        {
            object_ = CL_(clCreateBufferWithProperties)(
        ...
        cl_int* err = nullptr)
    {
        ...
        if (useHostPtr)
        {
            object_ = CL_(clCreateBuffer)(
                context(), flags, size, const_cast<DataType*>(&*startIterator), &error);
        }
        else
        {
        ...
        cl_int* err = nullptr)
    {
        ...
        cl_int error;
        result.object_ =
            CL_(clCreateSubBuffer)(object_, flags, buffer_create_type, buffer_create_info, &error);
...
class BufferD3D10 : public Buffer
{
  public:
     ...
     */
    BufferD3D10(
        const Context& context, cl_mem_flags flags, ID3D10Buffer* bufobj, cl_int* err = nullptr)
...
class BufferGL : public Buffer
{
  public:
    ...
    {
        cl_int error;
        object_ = CL_(clCreateFromGLBuffer)(context(), flags, bufobj, &error);
    ...
    {
        return detail::errHandler(
            CL_(clGetGLObjectInfo)(object_, type, gl_object_name), __GET_GL_OBJECT_INFO_ERR);
    }
};
...
class BufferRenderGL : public Buffer
{
  public:
     ...
     */
    BufferRenderGL(
        const Context& context, cl_mem_flags flags, cl_GLuint bufobj, cl_int* err = nullptr)
    {
        cl_int error;
        object_ = CL_(clCreateFromGLRenderbuffer)(context(), flags, bufobj, &error);
...
class Image : public Memory
{
  ...
  public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetImageInfo), object_, name, param), __GET_IMAGE_INFO_ERR);
    }
...
class Image1D : public Image
{
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        object_ = CL_(clCreateImage)(context(), flags, &format, &desc, host_ptr, &error);
        ...
        cl_int* err = nullptr)
    {
        ...
        {
            object_ = CL_(clCreateImageWithProperties)(
                context(), properties.data(), flags, &format, &desc, host_ptr, &error);
        }
...
class Image1DBuffer : public Image
{
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        object_ = CL_(clCreateImage)(context(), flags, &format, &desc, nullptr, &error);
        ...
        cl_int* err = nullptr)
    {
        ...
        {
            object_ = CL_(clCreateImageWithProperties)(
                context(), properties.data(), flags, &format, &desc, nullptr, &error);
        }
...
class CL_API_PREFIX__VERSION_1_1_DEPRECATED Image2DGL : public Image2D
{
  public:
    ...
    {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture2D)(context(), flags, target, miplevel, texobj, &error);
...
class Image3DGL : public Image3D
{
  public:
    ...
    {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture3D)(context(), flags, target, miplevel, texobj, &error);
...
class ImageGL : public Image
{
  public:
    ...
    {
        cl_int error;
        object_ = CL_(clCreateFromGLTexture)(context(), flags, target, miplevel, texobj, &error);
...
class Pipe : public Memory
{
  public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetPipeInfo), object_, name, param), __GET_PIPE_INFO_ERR);
    }
  ...
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        cl_sampler_properties sampler_properties[] = {
            ...
            filter_mode,
            0};
        object_ = CL_(clCreateSamplerWithProperties)(context(), sampler_properties, &error);
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetSamplerInfo), object_, name, param), __GET_SAMPLER_INFO_ERR);
    }
...
class Kernel : public detail::Wrapper<cl_kernel>
{
  public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetKernelInfo), object_, name, param), __GET_KERNEL_INFO_ERR);
    }
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetKernelWorkGroupInfo), object_, device(), name, param),
        ...
        size_type* param) const
    {
        ...
        return detail::errHandler(
            CL_(clGetKernelSubGroupInfo)(
                object_, dev(), name, range.size(), range.get(), sizeof(size_type), param, nullptr),
    ...
    size_type
    getSubGroupInfo(const cl::Device& dev, const cl::NDRange& range, cl_int* err = nullptr) const
    {
        size_type param;
    ...
    {
        return detail::errHandler(
            CL_(clSetKernelArgSVMPointer)(object_, index, argPtr.get()), __SET_KERNEL_ARGS_ERR);
    }
    ...
    {
        return detail::errHandler(
            CL_(clSetKernelArgSVMPointer)(object_, index, argPtr.data()), __SET_KERNEL_ARGS_ERR);
    }
    ...
    {
        return detail::errHandler(
            CL_(clSetKernelArgSVMPointer)(object_, index, argPtr), __SET_KERNEL_ARGS_ERR);
    }
#endif // #if CL_HPP_TARGET_OPENCL_VERSION >= 200
    ...
    {
        return detail::errHandler(
            CL_(clSetKernelArg)(object_, index, size, argPtr), __SET_KERNEL_ARGS_ERR);
    }
    ...
    {
        return detail::errHandler(CL_(clSetKernelExecInfo)(
            object_,
    ...
    void setSVMPointersHelper(
        std::array<void*, ArrayLength>& pointerList,
    ...
    {
        return detail::errHandler(CL_(clSetKernelExecInfo)(object_, param_name, sizeof(T), &val));
    }

    template <cl_kernel_exec_info name>
    cl_int
    setExecInfo(typename detail::param_traits<detail::cl_kernel_exec_info, name>::param_type& val)
    {
...
class Program : public detail::Wrapper<cl_program>
{
  public:
    ...
    Program(const string& source, bool build = false, cl_int* err = nullptr)
    {
        ...
        object_ = CL_(clCreateProgramWithSource)(context(), (cl_uint)1, &strings, &length, &error);
     ...
     */
    Program(
        const Context& context, const vector<char>& IL, bool build = false, cl_int* err = nullptr)
    {
        cl_int error;
     ...
     * \param err if non-nullptr will be set to CL_SUCCESS on successful operation or one of the
     ...
     * devices; or if any entry in binaries is nullptr or has length 0. CL_INVALID_DEVICE if OpenCL
        ...
        cl_int* err = nullptr)
    {
        ...
        object_ = CL_(clCreateProgramWithBinary)(
            ...
            lengths.data(),
            images.data(),
            (binaryStatus != nullptr && numDevices > 0) ? &binaryStatus->front() : nullptr,
            &error);
        ...
        void* data = nullptr) const
    {
        ...
        cl_int buildError = CL_(clBuildProgram)(object_, 1, &deviceID, options, notifyFptr, data);
    ...
    cl_int build(
        ...
        void* data = nullptr) const
    {
        cl_int buildError = CL_(clBuildProgram)(object_, 0, nullptr, options, notifyFptr, data);
        ...
        void* data = nullptr) const
    {
        cl_int error = CL_(clCompileProgram)(
            object_, 0, nullptr, options, 0, nullptr, nullptr, notifyFptr, data);
        return detail::buildErrHandler(
    ...
    {
        static_assert(
            sizeof(cl::Program) == sizeof(cl_program),
    ...
    {
        return compile(
            options.c_str(), deviceList, inputHeaders, headerIncludeNames, notifyFptr, data);
    }
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetProgramInfo), object_, name, param), __GET_PROGRAM_INFO_ERR);
    }
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetProgramBuildInfo), object_, device(), name, param),
    ...
    cl_int createKernels(vector<Kernel>* kernels)
    {
        ...
        err = CL_(clCreateKernelsInProgram)(object_, numKernels, value.data(), nullptr);
        if (err != CL_SUCCESS)
        {
            return detail::errHandler(err, __CREATE_KERNELS_IN_PROGRAM_ERR);
        }
    ...
    {
        return detail::errHandler(
            CL_(clSetProgramReleaseCallback)(object_, pfn_notify, user_data),
    ...
    {
        return detail::errHandler(
            CL_(clSetProgramSpecializationConstant)(object_, index, sizeof(value), &value),
    ...
    {
        return detail::errHandler(
            CL_(clSetProgramSpecializationConstant)(object_, index, size, value),
            __SET_PROGRAM_SPECIALIZATION_CONSTANT_ERR);
    }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 220
};
    ...
    cl_int* err = nullptr)
{
    ...
    cl_program prog =
        CL_(clLinkProgram)(ctx(), 0, nullptr, options, 2, programs, notifyFptr, data, &error_local);
...
template <> inline cl_int cl::Program::setSpecializationConstant(cl_uint index, const bool& value)
{
    ...
    return detail::errHandler(
        CL_(clSetProgramSpecializationConstant)(object_, index, sizeof(ucValue), &ucValue),
        __SET_PROGRAM_SPECIALIZATION_CONSTANT_ERR);
}
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 220
  ...
  public:
    ...
    CommandQueue(cl_command_queue_properties properties, cl_int* err = nullptr)
    {
        ...
        else
        {
            ...
            if (!useWithProperties)
            {
                object_ = CL_(clCreateCommandQueue)(context(), device(), properties, &error);
    ...
    explicit CommandQueue(
        const Context& context, cl_command_queue_properties properties = 0, cl_int* err = nullptr)
    {
        cl_int error;
        bool useWithProperties;
        ...
        if (!useWithProperties)
        {
            object_ = CL_(clCreateCommandQueue)(context(), devices[0](), properties, &error);
     ...
     * Will return an CL_INVALID_QUEUE_PROPERTIES error if CL_QUEUE_ON_DEVICE is specified.
     */
    explicit CommandQueue(const Context& context, QueueProperties properties, cl_int* err = nullptr)
    {
        cl_int error;
        bool useWithProperties;
        vector<cl::Device> devices;
    ...
    {
        return detail::errHandler(
            detail::getInfo(CL_(clGetCommandQueueInfo), object_, name, param),
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueReadBuffer)(
                ...
                (events != nullptr && events->size() > 0) ? (const cl_event*)&events->front()
                                                          : nullptr,
    ...
    typename std::enable_if<
        std::is_same<T, cl_float4>::value || std::is_same<T, cl_int4>::value ||
        ...
        Event* event = nullptr) const
    {
        return enqueueFillImage(
            image, fillColor, {origin[0], origin[1], 0}, {region[0], region[1], 1}, events, event);
    }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 120
    ...
    /**
     * Enqueues a command that copies a region of memory from the source pointer to the destination
     * pointer. This function is specifically for transferring data between the host and a
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemcpy)(
                object_,
                blocking,
                static_cast<void*>(dst_ptr),
                static_cast<const void*>(src_ptr),
                size,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0) ? (const cl_event*)&events->front()
                                                          : nullptr,
                (event != nullptr) ? &tmp : nullptr),
            __ENQUEUE_COPY_SVM_ERR);
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemcpy)(
                object_,
                blocking,
                static_cast<void*>(dst_ptr.get()),
                static_cast<const void*>(src_ptr.get()),
                size,
                (events != nullptr) ? (cl_uint)events->size() : 0,
                (events != nullptr && events->size() > 0) ? (const cl_event*)&events->front()
                                                          : nullptr,
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemcpy)(
                object_,
                blocking,
                static_cast<void*>(dst_container.data()),
    ...
    /**
     * Enqueues a command that fills a region of a coarse-grained SVM buffer with a specified
     * pattern. This variant takes a cl::pointer instance.
     */
    ...
    /**
     * Enqueues a command that will allow the host to fill a region of a coarse-grained SVM buffer
     * with a specified pattern. This variant takes a cl::vector instance.
     */
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMMemFill)(
                object_,
                static_cast<void*>(container.data()),
                static_cast<void*>(&pattern),
                sizeof(PatternType),
    ...
    template <typename T>
    cl_int
    enqueueUnmapSVM(T* ptr, const vector<Event>* events = nullptr, Event* event = nullptr) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
    ...
    cl_int enqueueUnmapSVM(
        cl::pointer<T, D>& ptr, const vector<Event>* events = nullptr, Event* event = nullptr) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueSVMUnmap)(
     ...
     */
    cl_int
    enqueueMarkerWithWaitList(const vector<Event>* events = nullptr, Event* event = nullptr) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
     ...
     */
    cl_int
    enqueueBarrierWithWaitList(const vector<Event>* events = nullptr, Event* event = nullptr) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueNativeKernel)(
                ...
                (mem_objects->size() > 0) ? reinterpret_cast<const cl_mem*>(mem_objects->data())
                                          : nullptr,
                (mem_locs != nullptr && mem_locs->size() > 0)
 ...
 */
    ...
    cl_int enqueueMarker(Event* event = nullptr) const CL_API_SUFFIX__VERSION_1_1_DEPRECATED
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_(clEnqueueMarker)(object_, (event != nullptr) ? &tmp : nullptr),
    ...
    CL_API_PREFIX__VERSION_1_1_DEPRECATED
    cl_int
    enqueueWaitForEvents(const vector<Event>& events) const CL_API_SUFFIX__VERSION_1_1_DEPRECATED
    {
        return detail::errHandler(
        ...
        Event* event = nullptr) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_(clEnqueueAcquireGLObjects)(
                object_,
                (mem_objects != nullptr) ? (cl_uint)mem_objects->size() : 0,
                (mem_objects != nullptr && mem_objects->size() > 0)
 ...
 */
    ...
    {
        return detail::errHandler(CL_(clEnqueueBarrier)(object_), __ENQUEUE_BARRIER_ERR);
    }
#endif // CL_USE_DEPRECATED_OPENCL_1_1_APIS
        ...
        Event* event = nullptr)
    {
        ...
        std::call_once(
            ext_memory_initialized_, initMemoryExtension, this->getInfo<CL_QUEUE_DEVICE>());
        ...
        if (pfn_clEnqueueAcquireExternalMemObjectsKHR)
        {
            err = pfn_clEnqueueAcquireExternalMemObjectsKHR(
                ...
                (events_wait != nullptr && events_wait->size() > 0)
                    ? reinterpret_cast<const cl_event*>(events_wait->data())
                    : nullptr,
                &tmp);
        }
...
class DeviceCommandQueue : public detail::Wrapper<cl_command_queue>
{
  public:
    ...
    DeviceCommandQueue(DeviceQueueProperties properties, cl_int* err = nullptr)
    {
        ...
        object_ =
            CL_(clCreateCommandQueueWithProperties)(context(), device(), queue_properties, &error);
    ...
    makeDefault(const Context& context, const Device& device, cl_int* err = nullptr)
    {
        cl_int error;
     ...
     */
    static DeviceCommandQueue updateDefault(
        const Context& context,
        const Device& device,
        ...
        cl_int* err = nullptr)
    {
        cl_int error;
        error =
            CL_(clSetDefaultDeviceCommandQueue)(context.get(), device.get(), default_queue.get());
 ...
 */
template <typename T>
inline cl_int enqueueUnmapSVM(T* ptr, const vector<Event>* events = nullptr, Event* event = nullptr)
{
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
    if (error != CL_SUCCESS)
    ...
    return detail::errHandler(queue.enqueueUnmapSVM(ptr, events, event), __ENQUEUE_UNMAP_SVM_ERR);
}
...
inline cl_int enqueueUnmapSVM(
    cl::pointer<T, D>& ptr, const vector<Event>* events = nullptr, Event* event = nullptr)
{
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
    if (error != CL_SUCCESS)
...
template <typename T, class Alloc>
inline cl_int enqueueUnmapSVM(
    cl::vector<T, Alloc>& container, const vector<Event>* events = nullptr, Event* event = nullptr)
{
    cl_int error;
    CommandQueue queue = CommandQueue::getDefault(&error);
    if (error != CL_SUCCESS)
    ...
    return detail::errHandler(
        queue.enqueueUnmapSVM(container, events, event), __ENQUEUE_UNMAP_SVM_ERR);
}
...
class EnqueueArgs
{
  ...
  public:
    ...
    EnqueueArgs(const vector<Event>& events, NDRange global)
        : queue_(CommandQueue::getDefault()), offset_(NullRange), global_(global),
          local_(NullRange), events_(events)
    {
    }
...
template <typename... Ts> class KernelFunctor
{
  private:
    ...
    template <int index, typename T0> void setArgs(T0&& t0)
    {
        kernel_.setArg(index, t0);
    }
  ...
  public:
    ...
    KernelFunctor(const Program& program, const string name, cl_int* err = nullptr)
...
template <typename... Ts> struct make_kernel
{
    ...
    make_kernel(const Program& program, const string name, cl_int* err = nullptr)
...
class Semaphore : public detail::Wrapper<cl_semaphore_khr>
{
  public:
        ...
        cl_int* err = nullptr)
    {
        ...
        {
            object_ = pfn_clCreateSemaphoreWithPropertiesKHR(context(), sema_props.data(), &error);
        }
    ...
    Semaphore(const vector<cl_semaphore_properties_khr>& sema_props, cl_int* err = nullptr)
        : Semaphore(Context::getDefault(err), sema_props, err)
    {
    }
    ...
    template <typename T> cl_int getInfo(cl_semaphore_info_khr name, T* param) const
    {
        if (pfn_clGetSemaphoreInfoKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __GET_SEMAPHORE_KHR_INFO_ERR);
        }
    ...
    template <cl_semaphore_info_khr name>
    typename detail::param_traits<detail::cl_semaphore_info_khr, name>::param_type
    getInfo(cl_int* err = nullptr) const
    {
        typename detail::param_traits<detail::cl_semaphore_info_khr, name>::param_type param{};
        cl_int result = getInfo(name, &param);
        if (err != nullptr)
        {
            *err = result;
        ...
        const Device& device, cl_external_semaphore_handle_type_khr name, T* param) const
    {
        ...
        {
            return detail::errHandler(
                CL_INVALID_OPERATION, __GET_SEMAPHORE_HANDLE_FOR_TYPE_KHR_ERR);
        }

        return detail::errHandler(
            detail::getInfo(pfn_clGetSemaphoreHandleForTypeKHR, object_, device(), name, param),
            __GET_SEMAPHORE_HANDLE_FOR_TYPE_KHR_ERR);
    }

    template <cl_external_semaphore_handle_type_khr type>
    typename detail::param_traits<detail::cl_external_semaphore_handle_type_khr, type>::param_type
    getHandleForTypeKHR(const Device& device, cl_int* err = nullptr) const
    {
        typename detail::param_traits<detail::cl_external_semaphore_handle_type_khr, type>::
            param_type param;
    ...
    cl_int retain()
    {
        if (pfn_clRetainSemaphoreKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __RETAIN_SEMAPHORE_KHR_ERR);
        }
    ...
    cl_int release()
    {
        if (pfn_clReleaseSemaphoreKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __RELEASE_SEMAPHORE_KHR_ERR);
        }
  ...
  private:
    ...
    static void initExtensions(const Context& context)
    {
        ...
        if ((pfn_clCreateSemaphoreWithPropertiesKHR == nullptr) &&
            (pfn_clReleaseSemaphoreKHR == nullptr) && (pfn_clRetainSemaphoreKHR == nullptr) &&
    ...
    Event* event) const
{
    ...
    if (pfn_clEnqueueWaitSemaphoresKHR != nullptr)
    {
        err = pfn_clEnqueueWaitSemaphoresKHR(
            ...
            (events_wait_list != nullptr && events_wait_list->size() > 0)
...
class CommandBufferKhr : public detail::Wrapper<cl_command_buffer_khr>
{
  public:
        ...
        cl_int* errcode_ret = nullptr)
    {
        ...
        static_assert(
            sizeof(cl::CommandQueue) == sizeof(cl_command_queue),
    ...
    template <typename T> cl_int getInfo(cl_command_buffer_info_khr name, T* param) const
    {
        if (pfn_clGetCommandBufferInfoKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __GET_COMMAND_BUFFER_INFO_KHR_ERR);
        }
        return detail::errHandler(
    ...
    typename detail::param_traits<detail::cl_command_buffer_info_khr, name>::param_type
    getInfo(cl_int* err = nullptr) const
    {
        typename detail::param_traits<detail::cl_command_buffer_info_khr, name>::param_type param{};
        cl_int result = getInfo(name, &param);
        if (err != nullptr)
        {
            *err = result;
    ...
    cl_int enqueueCommandBuffer(
        vector<CommandQueue>& queues, const vector<Event>* events = nullptr, Event* event = nullptr)
    {
        if (pfn_clEnqueueCommandBufferKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __ENQUEUE_COMMAND_BUFFER_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(
                CL_INVALID_OPERATION, __COMMAND_BARRIER_WITH_WAIT_LIST_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_COPY_BUFFER_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_COPY_BUFFER_RECT_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_COPY_BUFFER_TO_IMAGE_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_COPY_IMAGE_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_COPY_IMAGE_TO_BUFFER_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_FILL_BUFFER_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_FILL_IMAGE_KHR_ERR);
        }
        ...
        const CommandQueue* command_queue = nullptr)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __COMMAND_NDRANGE_KERNEL_KHR_ERR);
        }
    ...
    cl_int updateMutableCommands(const cl_mutable_base_config_khr* mutable_config)
    {
        ...
        {
            return detail::errHandler(CL_INVALID_OPERATION, __UPDATE_MUTABLE_COMMANDS_KHR_ERR);
        }
        return detail::errHandler(
...
#else
    template <int ArrayLength>
    cl_int updateMutableCommands(
        std::array<cl_command_buffer_update_type_khr, ArrayLength>& config_types,
        std::array<const void*, ArrayLength>& configs)
    {
        ...
        return detail::errHandler(
            pfn_clUpdateMutableCommandsKHR(
                object_, static_cast<cl_uint>(configs.size()), config_types.data(), configs.data()),
            __UPDATE_MUTABLE_COMMANDS_KHR_ERR);
    }
  ...
  private:
    ...
    static void initExtensions(const cl::Device& device)
    {
        ...
        if ((pfn_clCreateCommandBufferKHR == nullptr) &&
            ...
            (pfn_clCommandFillBufferKHR == nullptr) && (pfn_clCommandFillImageKHR == nullptr) &&
...
class MutableCommandKhr : public detail::Wrapper<cl_mutable_command_khr>
{
  public:
    ...
    explicit MutableCommandKhr(
        const cl_mutable_command_khr& mutableCommandKhr, bool retainObject = false)
    ...
    template <typename T> cl_int getInfo(cl_mutable_command_info_khr name, T* param) const
    {
        if (pfn_clGetMutableCommandInfoKHR == nullptr)
        {
            return detail::errHandler(CL_INVALID_OPERATION, __GET_MUTABLE_COMMAND_INFO_KHR_ERR);
        }
        return detail::errHandler(
    ...
    typename detail::param_traits<detail::cl_mutable_command_info_khr, name>::param_type
    getInfo(cl_int* err = nullptr) const
    {
        typename detail::param_traits<detail::cl_mutable_command_info_khr, name>::param_type
            param{};
