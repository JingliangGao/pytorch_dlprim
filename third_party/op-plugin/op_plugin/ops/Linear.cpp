...
class linear_cls : public torch::autograd::Function<linear_cls>
{
  public:
    ...
    static at::Tensor linear_forward(
        AutogradContext* ctx,
        const at::Tensor& input,
        const at::Tensor& weight,
        const c10::optional<at::Tensor>& bias)
    ...
    static tensor_list linear_backward(AutogradContext* ctx, tensor_list grad_outputs)
    {
        ...
        if (has_bias)
        {
            ...
            auto bwd_bias =
                dlprim::core::BiasBackwardFilter::create(dlprim_ctx, dY.shape(), cfg.dtype);
            at::DataPtr ptr;
...
at::Tensor
linear(const at::Tensor& input, const at::Tensor& weight, const c10::optional<at::Tensor>& bias)
{
