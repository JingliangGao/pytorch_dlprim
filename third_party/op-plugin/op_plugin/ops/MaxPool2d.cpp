...
class max_pool2d_cls : public torch::autograd::Function<max_pool2d_cls>
{
  public:
    ...
    static at::Tensor max_pool2d_forward(
        AutogradContext* ctx,
        at::Tensor const& self,
        IntArrayRef kernel_size,
        IntArrayRef stride,
        ...
        bool ceil_mode)
    {
        ...
        dlprim::Shape y_shape = dlprim::Shape(
            ...
            dlprim::core::calc_pooling_output_size(
                x_shape[2], kernel[0], pad[0], strd[0], ceil_mode),
            dlprim::core::calc_pooling_output_size(
                x_shape[3], kernel[1], pad[1], strd[1], ceil_mode));
        ...
        auto pool = dlprim::core::Pooling2DForward::create_max_pooling(
            dlprim_ctx, kernel, pad, strd, todp(self.dtype()));
        pool->enqueue(X, Y, q);
    ...
    static tensor_list max_pool_2d_backward(AutogradContext* ctx, tensor_list grad_outputs)
    {
        ...
        auto pool = dlprim::core::MaxPooling2DBackward::create(
            dlprim_ctx, kernel, pad, strd, todp(input.dtype()));
