...
static at::Tensor&
log_softmax_out_nocheck(const at::Tensor& self, int64_t dim, bool is_log, at::Tensor& out)
{
...
at::Tensor&
_log_softmax_out(const at::Tensor& self, int64_t dim, bool /*half_to_float*/, at::Tensor& out)
{
