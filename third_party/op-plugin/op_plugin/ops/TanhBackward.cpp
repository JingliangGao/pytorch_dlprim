...
at::Tensor&
tanh_backward_out(const at::Tensor& grad_output, const at::Tensor& output, at::Tensor& grad_input)
{
    ...
    dlprim::core::activation_backward(
        dX, dY, Y, dlprim::StandardActivations::tanh, 0.0, getExecutionContext(grad_output));
