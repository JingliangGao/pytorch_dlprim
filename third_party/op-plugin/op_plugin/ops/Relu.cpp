...
//     dlprim::core::activation_forward(x,y,dlprim::StandardActivations::relu,
//     getExecutionContext(self)); sync_if_needed(self.device()); return out;
// }
...
template <dlprim::StandardActivations Act> torch::Tensor act_autograd(torch::Tensor const& x)
{
