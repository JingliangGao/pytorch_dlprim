...
thread_local c10::Device KPUGuardImpl::current_device_ =
    c10::Device(c10::DeviceType::PrivateUse1, 0);
thread_local c10::Stream KPUGuardImpl::current_stream_ =
    c10::Stream(c10::Stream::UNSAFE, c10::Device(c10::DeviceType::PrivateUse1, 0), 0);

/* check device type */
KPUGuardImpl::KPUGuardImpl(c10::DeviceType t)
{
    TORCH_INTERNAL_ASSERT(
        t == c10::DeviceType::PrivateUse1, "DeviceType must be KPU. Actual DeviceType is: ", t);
}
...
c10::Device KPUGuardImpl::exchangeDevice(c10::Device d) const
{
    TORCH_INTERNAL_ASSERT(
        ...
        "DeviceType must be KPU. Actual DeviceType is: ",
        d.type());
...
{
    TORCH_INTERNAL_ASSERT(
        s.device().type() == c10::DeviceType::PrivateUse1,
        "DeviceType must be KPU. Actual DeviceType is: ",
        s.device().type());
...
{
    TORCH_INTERNAL_ASSERT(
        stream.device().type() == c10::DeviceType::PrivateUse1,
        "DeviceType must be KPU. Actual DeviceType is: ",
        stream.device().type());
